package com.sensinggo.sensing.FileSender;
...
public class sendData extends AsyncTask<Void, String, Integer> {
  ...
  public boolean connectSFTPServer(){
    try {
      ...
      Log.d("hostohst", "");
      mSession = jsch.getSession("", "", ); // port 22
  ...
  protected Integer doInBackground(Void... params) {
    if (connectSFTPServer()) {
      ...
      try {
        ...
        Log.i("sender", mContext.getFilesDir().getPath().toString() + "/" + UserID_path + "");
        Log.i("sender", "" + UserID_path + "");
        ...
        sftpChannel.put(mContext.getFilesDir().getPath().toString() + "/" + UserID_path + "",
            "/home/yicchen/Desktop/" + UserID_path + cTime + "");
        // sftpChannel.put(mContext.getFilesDir().getPath().toString()+"/"+UserID_path+".json","/home/yicchen/Desktop/"+UserID_path+cTime+".json");
